...
const products = [
  ...
  // 'https://cdn.shopify.com/s/files/1/0209/8446/t/147/assets/fb3852ee3374--SweetBiome-100ml-C-6K-2_720x.png?v=1609803312',
    ...
    <>
      <div className='ml-10 py-8 caret-pink-500 custom_cursor'>
        <h1
          ...
          className='text-yellow-300 tracking-widest text-center font-semibold'
        >
          the line
        </h1>
        ...
        <div className='flex justify-around '>
          {products.map((product) => {
            return (
              <div className='relative hover:opacity-60 hover:bg-pink-500 rounded-full h-72 w-72'>
                <img draggable='true' alt='product' src={`${product}`}></img>
